...
const Home = () => {
  ...
  return (
    ...
    >
      <div className="relative w-full h-screen overflow-hidden before:absolute before:top-0 before:start-1/2 before:bg-[url('https://preline.co/assets/svg/examples/polygon-bg-element.svg')] before:bg-no-repeat before:bg-top before:size-full before:-z-1 before:transform before:-translate-x-1/2">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10 h-full">
          {/* Announcement Banner */}
          <div className="flex justify-center">
            <a
              ...
              href="#"
            >
              Welcome to Express Authentication
          ...
          <div className="mt-2 text-center mx-auto">
            <h1 className="block font-extrabold text-primary-700 text-4xl md:text-5xl lg:text-6xl">
          ...
          <div className="mt-5 max-w-xl text-center mx-auto">
            <h1 className="block font-bold text-gray-800 text-3xl md:text-4xl lg:text-5xl">
